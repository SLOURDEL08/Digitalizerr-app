...
const ProcessStep: React.FC<ProcessStepProps> = ({ title, description }) => (
  <div className='bg-[#00000020] hover:bg-[#00000030] transition-all relative text-center p-8 rounded-3xl w-[30%] space-y-2 pt-14'>
  ...
  return (
    <div className='min-h-screen flex flex-col items-center justify-center gap-14 '>
      <div className='relative w-full text-center flex justify-center'>
              <h6 className='text-[#F6D663] text-8xl'>Notre processus</h6>
              <div className='flex fle items-start'>
                  <img src={starImage} alt='star' className='w-20 -mt-4 ml-10 h-auto' />
                  <img src={starImage} alt='star' className='w-14 mt-20' />
              </div>
        
      </div>
      
      <div className='flex flex-wrap gap-14 w-full text-white justify-center'>
